---
title: "Akshay 🚀 on X: \"The Anatomy of an Agent Harness \" / X"
...
![Image](https://pbs.twimg.com/media/HFOTX8na4AACHWq?format=jpg&name=medium)



](https://x.com/akshay_pachaar/article/2041146899319971922/media/2041137095746707456)
...
![Image](https://pbs.twimg.com/media/HFOXoJ3aYAAGt9F?format=jpg&name=medium)



](https://x.com/akshay_pachaar/article/2041146899319971922/media/2041141772227862528)
...
Claude Code provides tools across six categories: file operations, search, execution, web access, code intelligence, and subagent spawning. OpenAI's Agents SDK supports function tools (via

), hosted tools (WebSearch, CodeInterpreter, FileSearch), and MCP server tools.

Memory operates at multiple timescales. Short-term memory is conversation history within a single session. Long-term memory persists across sessions: Anthropic uses

project files and auto-generated

files; LangGraph uses namespace-organized JSON Stores; OpenAI supports Sessions backed by SQLite or Redis.
...
OpenAI's Codex uses a strict priority stack: server-controlled system message (highest priority), tool definitions, developer instructions, user instructions (cascading

files, 32 KiB limit), then conversation history.
...
![Image](https://pbs.twimg.com/media/HFOYY_KbIAAzilX?format=jpg&name=medium)



](https://x.com/akshay_pachaar/article/2041146899319971922/media/2041142611168403456)
...
![Image](https://pbs.twimg.com/media/HFOZ6DqawAAMSNf?format=jpg&name=medium)



](https://x.com/akshay_pachaar/article/2041146899319971922/media/2041144278823649280)
...
![Image](https://pbs.twimg.com/media/HFOahFWa0AEinPz?format=jpg&name=medium)



](https://x.com/akshay_pachaar/article/2041146899319971922/media/2041144949291536385)
...
![Image](https://pbs.twimg.com/media/HFOar2zakAA_hnk?format=jpg&name=medium)



](https://x.com/akshay_pachaar/article/2041146899319971922/media/2041145134365184000)

Every harness architect faces seven choices:

[

![Image](https://pbs.twimg.com/media/HFOaz7xakAAwJTU?format=jpg&name=medium)



](https://x.com/akshay_pachaar/article/2041146899319971922/media/2041145273137926144)
